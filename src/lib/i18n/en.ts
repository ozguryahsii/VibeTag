...
export const en = {
  ...
  photos: {
    title: "My photos",
    body: "Your plan holds {n} photos. One is your profile picture; the other {side} show as small circles beside it.",
    bodyFree: "Your plan holds one photo — your profile picture. Silver and Gold add more, shown as circles beside it.",
    add: "Add a photo",
    adding: "Uploading…",
    added: "Photo added.",
    full: "Your plan holds {n} photos. Delete one to add another.",
    main: "Profile",
    setMain: "Make this my profile picture",
    side: "Side",
    count: "{used} of {max} photos",
    sideCount: "{n} beside your photo",
    deletePhoto: "Delete photo",
  },
  photo: {
    cropTitle: "Choose your crop",
    cropHint:
      "Drag the circle over the part you want. Pinch or use the slider to resize the photo.",
    zoom: "Zoom",
    zoomOut: "Smaller",
    zoomIn: "Larger",
    use: "Use this",
  ...
  legal: {
    ...
    draftNotice:
      "Not yet in force. These texts were reviewed and revised by counsel, and the operator, address, venue and liability cap are now filled in. What remains is appointing an EU/EEA representative; until that name is in the text, this is not a final agreement — treat it as a working document.",
    title: "Legal",
