...
export const tr: Dictionary = {
  ...
  badgesPage: {
    ...
    detailHow: "Nasıl kazanılır",
    detailEarned: "Kazanıldı",
  ...
  photos: {
    title: "Fotoğraflarım",
    body: "Planın {n} fotoğraf saklıyor. Biri profil fotoğrafın; diğer {side} tanesi onun yanında küçük yuvarlaklar olarak görünür.",
    bodyFree: "Planın tek fotoğraf saklıyor — profil fotoğrafın. Silver ve Gold, yanında yuvarlak olarak görünen fotoğraflar ekler.",
    add: "Fotoğraf ekle",
    adding: "Yükleniyor…",
    added: "Fotoğraf eklendi.",
    full: "Planın {n} fotoğraf saklıyor. Yenisini eklemek için birini sil.",
    main: "Profil",
    setMain: "Profil fotoğrafım yap",
    side: "Yan",
    count: "{max} fotoğraftan {used} tanesi",
    sideCount: "{n} tanesi fotoğrafının yanında",
    deletePhoto: "Fotoğrafı sil",
  },
  photo: {
    cropTitle: "Kırpmayı seç",
    cropHint:
      "Halkayı istediğin yere sürükle. Fotoğrafı büyütüp küçültmek için kaydırıcıyı kullan.",
    zoom: "Yakınlaştır",
    zoomOut: "Küçült",
    zoomIn: "Büyüt",
    use: "Bunu kullan",
