...
export const ICONS: Record<string, IconDef> = {
  ...
  search: {
    circles: [[10.8, 10.8, 6.6]],
    paths: ["M15.6 15.6 20.8 20.8"],
  },
  medal: {
    circles: [[12, 9, 5.2]],
  ...
  envelope: {
    paths: [
      "M3.4 6.4h17.2v11.2a1.4 1.4 0 0 1-1.4 1.4H4.8a1.4 1.4 0 0 1-1.4-1.4z",
      "M3.9 7 12 13.1 20.1 7",
    ],
  },
  bell: {
    paths: [
      "M18.4 16.4V11a6.4 6.4 0 0 0-12.8 0v5.4L3.8 18.6h16.4z",
      "M9.8 21.2a2.4 2.4 0 0 0 4.4 0",
    ],
  },
  store: {
    paths: [
